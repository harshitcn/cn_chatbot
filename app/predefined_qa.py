...
PREDEFINED_QA: List[Dict[str, str]] = [
    {
        ...
        "answer": "['Parent/Guardian', 'Existing Franchise Owner']"
    },
    {
        "question": "Parent/Guardian",
        "answer": "['Enroll or learn about programs for my kids', 'Know more about CAMPS', 'Know more about Clubs', 'Know more about Academies', 'Know more about CREATE', 'Know more about JR', 'Know more about Parent's Night Out', 'Know more about Birthday Parties', 'Know more about Home Schooling', 'Know more about After School Programs', 'Know more about PTO/PTA', 'Know more about Upcoming Events/Programs', 'Ask a general question about a program', 'Go back to Main Menu']"
    },
    {
        "question": "Existing Franchise Owner",
        "answer": "['I want to know more about Franchise Ownership', 'I want to sell my Franchise', 'I want to own a new Franchise', 'I want to raise a support issue', 'I have another concern', 'Ask a general question regarding Franchisee cost, ownership and returns', 'Go back to Main Menu']"
    },
]
